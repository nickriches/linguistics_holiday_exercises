...
I fought the law and the law `r mcq(c("lost", answer = "won","went and bloody well triumphed"))` CLAUSE TYPES: `r mcq(c("single clause", answer = "conjoined clause", "embedded clause"))` Bloody fuck



poopThis is a Web Exercise template created by the [psychology teaching team at the University of Glasgow](http://www.psy.gla.ac.ukUniversity of Glasgow), based on ideas by [Software Carpentry](https://software-carpentry.org/lessons/). This template enables instructors to easily create web documents that students can use in self-assessment.
